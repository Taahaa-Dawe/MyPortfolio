...
def Intro():
	...
	st.write("""<center><a href="https://ibb.co/QYZcFNY"><img src="https://i.ibb.co/tYShMsY/image.png" alt="image" border="0">Figure 2: Tamazight spelt in Tifinagh (left) and Romanized (right).<br /></center> """ , unsafe_allow_html=True)
	st.write("")
	...
	st.write("""<center><a href="https://ibb.co/LvLK613"><img src="https://i.ibb.co/d7dZ6DR/image.png" alt="image" border="0"></a><br /><Figure 3: Linguistic Map of Morocco – 3 main languages ( <a href ="https://www.reddit.com/r/MapPorn/comments/p4ywvf/distribution_of_berberamazigh_languages_in_morocco/"> left</a>) and 3 Amazigh dialects ( <a href ="https://www.instagram.com/amazighworldnews/p/C8FoLiwuJ59/">right</a>).<br /></center>""", unsafe_allow_html=True)
	st.write("")
