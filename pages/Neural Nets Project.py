...
def Methodology():
 ...
 <a href="https://ibb.co/VBVzxZd"><img src="https://i.ibb.co/RH2sNm1/image.png" alt="image" border="0"></a><br />Figure 12: Sample from cleaned dataset with Tamazight in Tifinagh (left) and English (right).</a><br />
	...
	st.write("")
	st.write("""<center> 
 <a href="https://ibb.co/bPWc0wv"><img src="https://i.ibb.co/nbgxGd1/image.png" alt="image" border="0"></a><br />Figure 15: Architecture of a Sequence-to-Sequence Model (Github).</a><br />
 </center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write(""" <center><a href="https://ibb.co/2NRHRKm"><img src="https://i.ibb.co/k1zvzck/image.png" alt="image" border="0"></a><br />Figure 16: Architecture of a Transformer Model (Attention is All you Need).</a><br /></center>""",unsafe_allow_html=True)
	st.write("")
