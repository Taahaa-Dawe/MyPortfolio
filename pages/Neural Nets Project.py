...
""")
	st.write("""<a href="https://ibb.co/QYZcFNY"><img src="https://i.ibb.co/tYShMsY/image.png" alt="image" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'>Figure 2: Tamazight spelt in Tifinagh (left) and Romanized (right).</a><br /> """, , unsafe_allow_html=True)
	...
	st.write("""<a href="https://ibb.co/LvLK613"><img src="https://i.ibb.co/d7dZ6DR/image.png" alt="image" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'>Figure 3: Linguistic Map of Morocco – 3 main languages (left) and 3 Amazigh dialects (right).</a><br />""", unsafe_allow_html=True)
	...
	st.write("""<a href="https://ibb.co/6PqD6B5"><img src="https://i.ibb.co/jMj37RF/image.png" alt="image" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'>Figure 4: Students in a Moroccan classroom with names in Tifinagh <a href = "https://www.instagram.com/amazighworldnews/p/C7rcG3cMg7O/?img_index=1">(Amazighworldnews).</a></a><br /> """, unsafe_allow_html=True)
	...
	st.write("""<a href="https://imgbb.com/"><img src="https://i.ibb.co/Zmh3mDK/image.png" alt="image" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'>Figure 5: Moroccan Tamazight on EGIDS (Ethnologue).</a><br />""",unsafe_allow_html=True)
