...
def Intro():
	...
	st.write(""" <center>
 	<a href="https://ibb.co/GPvJbS3"><img src="https://i.ibb.co/h8RMtz1/image.png" alt="image" border="0"></a><br />Figure 1: Percentages of Amazigh Population in Africa (<a href='https://www.instagram.com/amazighworldnews/p/C8SmeVtNzN3/'>African Mapper </a>).<br />
	...
	st.write("""<center><a href="https://ibb.co/QYZcFNY"><img src="https://i.ibb.co/tYShMsY/image.png" alt="image" border="0"> <br />Figure 2: Tamazight spelt in Tifinagh (left) and Romanized (right).<br /></center> """ , unsafe_allow_html=True)
	st.write("")
	...
	st.write("""<center><a href="https://ibb.co/LvLK613"><img src="https://i.ibb.co/d7dZ6DR/image.png" alt="image" border="0"></a><br />
 Figure 3: Linguistic Map of Morocco – 3 main languages
 (<a href="https://www.reddit.com/r/MapPorn/comments/p4ywvf/distribution_of_berberamazigh_languages_in_morocco/">left</a>) and 3 Amazigh dialects (<a href ="https://www.instagram.com/amazighworldnews/p/C8FoLiwuJ59/">right</a>).<br /></center>""", unsafe_allow_html=True)
	st.write("")
	...
	st.write("""<center><a href="https://ibb.co/6PqD6B5"><img src="https://i.ibb.co/jMj37RF/image.png" alt="image" border="0"></a><br />Figure 4: Students in a Moroccan classroom with names in Tifinagh <a href = "https://www.instagram.com/amazighworldnews/p/C7rcG3cMg7O/?img_index=1">(Amazighworldnews).</a><br /> </center>""", unsafe_allow_html=True)
	st.write("")
	...
	st.write("""<center><a href="https://imgbb.com/"><img src="https://i.ibb.co/Zmh3mDK/image.png" alt="image" border="0"></a><br />Figure 5: Moroccan Tamazight on EGIDS (<a href ="https://www.instagram.com/amazighworldnews/p/C7rcG3cMg7O/?img_index=1"> Ethnologue</a>).<br /></center>""",unsafe_allow_html=True)
	st.write("")
...
def DataPreparation():
	...
	st.write("")
	st.write("""<center> 
 <a href="https://ibb.co/StTZDw9"><img src="https://i.ibb.co/fkRTVdP/image.png" alt="image" border="0"></a><br />Figure 6: Tifinagh from Wikipedia with 31 letters in total.</a><br />
 	</center>""",unsafe_allow_html=True)
	st.write("")
	st.write("""<center> 
 	<a href="https://ibb.co/10tVG6D"><img src="https://i.ibb.co/TwxXMLV/image.png" alt="image" border="0"></a><br />Figure 7: Sentence Pairs (Amazigh – English) from Tatoeba with 15,371 rows (before cleaning).</a><br />
  	</center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write("")
	st.write("""<center> <a href="https://ibb.co/Wcjc6Dy"><img src="https://i.ibb.co/wKjKRJW/image.png" alt="image" border="0"></a><br />Figure 8: Sentence Pairs (Amazigh – English) from Tatoeba with 10,670 rows (after cleaning).</a><br /> </center>""",unsafe_allow_html=True)
	st.write("")
	st.subheader("Data Exploration")
	st.write("""<center><a href="https://ibb.co/YdY45JM"><img src="https://i.ibb.co/2Mm0zRQ/image.png" alt="image" border="0"></a><br />Figure 9: English (Left) and Tamazight’s (Right) count of words in descending order.</a><br /></center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write("""<center><a href="https://imgbb.com/"><img src="https://i.ibb.co/Jd3GKKG/image.png" alt="image" border="0"></a><br />Figure 10: WordCloud of English Sentences in the Dataset.</a><br /></center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write("")
	st.write("""<center><a href="https://imgbb.com/"><img src="https://i.ibb.co/8D0mfkW/image.png" alt="image" border="0"></a><br />Figure 11: WordCloud of English Sentences in the Dataset</a><br /></center>""",unsafe_allow_html=True)
	st.write("")
...
def Methodology():
	...
	st.write("""<center>
 <a href="https://ibb.co/VBVzxZd"><img src="https://i.ibb.co/RH2sNm1/image.png" alt="image" border="0"></a><br />Figure 12: Sample from cleaned dataset with Tamazight in Tifinagh (left) and English (right).</a><br />
 	</center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write("""<center><a href="https://imgbb.com/"><img src="https://i.ibb.co/ys4wXHJ/image.png" alt="image" border="0"></a><br />Figure 13: Sample from cleaned dataset with Romanized Tamazight.</a><br /></center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write("")
	st.write("""<center><a href="https://imgbb.com/"><img src="https://i.ibb.co/Bzx9DNy/image.png" alt="image" border="0"></a><br />Figure 14: Sample of tokenized and padded data.</a><br /></center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write("")
	st.write("""<center> 
 <a href="https://ibb.co/bPWc0wv"><img src="https://i.ibb.co/nbgxGd1/image.png" alt="image" border="0"></a><br />Figure 15: Architecture of a Sequence-to-Sequence Model (<a href ="https://github.com/sooftware/seq2seq"> Github</a>).<br />
 </center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write(""" <center><a href="https://ibb.co/2NRHRKm"><img src="https://i.ibb.co/k1zvzck/image.png" alt="image" border="0"></a><br />Figure 16: Architecture of a Transformer Model (<a href ="https://arxiv.org/abs/1706.03762"> Attention is All you Need</a>).<br /></center>""",unsafe_allow_html=True)
	st.write("")
...
def Conclusions():
	...
	st.write("""<center><a href="https://ibb.co/KxFgh1z"><img src="https://i.ibb.co/LdnyRGh/image.png" alt="image" border="0"></a><br />Figure 25: Quote from <a href ="https://www.euronews.com/2023/01/31/morocco-amazigh">EuroNews.</a><br /> </center>""",unsafe_allow_html=True)
	st.write("")
	...
	st.write("""<center><a href="https://ibb.co/bJYyX13"><img src="https://i.ibb.co/YZJKh2W/image.png" alt="image" border="0"></a><br />Figure 26: Amazigh Traditional Clothing (<a href = "https://www.reuters.com/world/africa/moroccos-amazigh-speakers-fear-indigenous-language-fading-2023-01-30/">Reuters </a>).<br /> </center>""",unsafe_allow_html=True)
	st.write("")
